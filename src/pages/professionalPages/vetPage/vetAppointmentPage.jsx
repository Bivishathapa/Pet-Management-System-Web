      ...
      <div className="bg-white rounded-2xl shadow-lg p-5 mb-6">
        <div className="max-w-md">
          ...
          <div className="relative">
            <input
              type="text"
              placeholder="Search by customer, pet name, or appointment type..."
              value={searchTerm}
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-indigo-600 text-white">
                  ...
                  <th className="px-6 py-4 text-left text-sm font-semibold">Appointment Type</th>
                  ...
                  filtered.map((apt, index) => {
                    ...
                    return (
                      <tr key={apt.id} className="hover:bg-indigo-50 transition-colors">
                        ...
                        <td className="px-6 py-4">
                          <span className="text-sm text-gray-700 capitalize">{appointmentType}</span>
                        </td>
